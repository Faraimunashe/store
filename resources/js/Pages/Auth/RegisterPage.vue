        ...
        <div class="w-full max-w-md bg-white shadow-lg rounded-lg p-8 animate-fadeIn transform transition duration-500 ease-in-out">
            ...
            <form @submit.prevent="submit" class="mt-6 animate-fadeIn delay-200">
                ...
                <div class="mb-4 relative">
                    ...
                    />
                    <span class="absolute top-10 left-3 text-gray-400"><i class="fas fa-user"></i></span>
                ...
                <div class="mb-4 relative">
                    ...
                    <input
                        ...
                        class="w-full px-12 py-3 mt-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600"
                    />
                    <span class="absolute top-10 left-3 text-gray-400"><i class="fas fa-envelope"></i></span>
                ...
                <div class="mb-4 relative">
                    ...
                    <input
                        ...
                        class="w-full px-12 py-3 mt-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600"
                    />
                    <span class="absolute top-10 left-3 text-gray-400"><i class="fas fa-lock"></i></span>
    ...
    form.post('/register', {
        onFinish: () => {
            ...
            if (form.wasSuccessful) {
                snackbar.add({
                    type: 'success',
                    text: 'Registration successful! Welcome to TechSight Solutions.'
                });
                form.reset();
            }
        }
