    ...
    <div class="bg-gray-50 py-12 px-6 mt-16 mb-20">
        <div class="max-w-8xl mx-auto bg-white p-8 rounded-lg shadow-lg border border-gray-200">
            ...
            <div class="flex items-center mb-6 border-b pb-4">
                ...
                <h2 class="text-3xl font-bold text-gray-800">{{ order.user.name }}'s Order</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="p-5 bg-gray-100 rounded-lg shadow-sm border border-gray-200">
                    ...
                    <p><strong>Joined:</strong> {{ formatDate(order.user.created_at) }}</p>
                </div>
            </div>
            ...
            <div class="mt-6 p-5 bg-gray-100 rounded-lg shadow-sm border border-gray-200">
                ...
                <div v-else class="text-center bg-yellow-500 text-white py-2 font-bold rounded-lg mb-4">This order is still in store.</div>
                <Link :href="`/adminorders/${order.id}/edit`" class="mt-4 bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 mx-auto">Update Order Tracking</Link>
            </div>
        </div>
    </div>
</template>
